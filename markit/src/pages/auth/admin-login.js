...
import { IconShield, IconMail, IconLock } from '../../components/common/Icons';
...
const AdminLogin = () => {
    ...
    return (
        <>
            ...
            <div className="min-vh-100 d-flex align-items-center justify-content-center" style={{ background: 'linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 100%)' }}>
                <div className="card border-0 shadow-lg" style={{ width: 420, borderRadius: 16, borderTop: '4px solid #3B82F6' }}>
                    <div className="card-body p-5">
                        <div className="text-center mb-4">
                            <div className="d-inline-flex align-items-center justify-content-center rounded-circle mb-3"
                                style={{ width: 64, height: 64, backgroundColor: '#EFF6FF' }}>
                                <IconShield size={28} color="#3B82F6" />
                            </div>
                            <h4 className="fw-bold" style={{ color: '#1E40AF' }}>Admin Login</h4>
                            <p className="text-muted" style={{ fontSize: 14 }}>Access the administrative dashboard</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="btn text-white w-100 py-2 fw-semibold" style={{ backgroundColor: '#3B82F6', borderRadius: 10 }} disabled={loading}>
                                {loading ? 'Signing in...' : 'Sign In'}
                            </button>
                        </form>

                        <div className="mt-3 p-3 rounded" style={{ backgroundColor: '#F0F9FF', fontSize: 12 }}>
                            <div className="fw-semibold mb-1" style={{ color: '#1D4ED8' }}>Demo Credentials</div>
                            <div>Email: admin@petms.gov.in</div>
